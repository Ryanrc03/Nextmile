...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2F1msirius%2FNextmile)
...
```
pnpm create next-app --example https://github.com/1msirius/Nextmile nextmile
```
...
Nextmile is open-source and released under the MIT License.
